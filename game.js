...
function enableInputs() {
    juego.addEventListener('mousedown',
        function(evt) {
            lastPress = evt.which; 
        },
        false
    ...
    juego.addEventListener('mouseup',
        function(evt) {
            lastPress = 0; 
        },
        false
...
function jugar() {
	...
	while (contador < 16) {
		...
		if (ser[contador].choque(ser[2]) == 1 && ser[2].estado != 12 && ser[contador].vida > 0)  {
			ser[2].estado = 12; 
			ser[2].subestado = 5; 
	...
	while (contador < 21) {
		...
		if (ser[contador].choque(ser[1]) == 1 && ser[1].estado != 12 && ser[contador].vida > 0) {
			ser[1].estado = 12; 
			ser[1].subestado = 5; 
	...
	if (ser[22].choque(ser[2]) == 1 && ser[2].estado != 12 && ser[22].vida > 0) {
		ser[2].estado = 12; 
		ser[2].subestado = 5; 
	...
	if (ser[23].choque(ser[1]) == 1 && ser[1].estado != 12 && ser[23].vida > 0) {
		ser[1].estado = 12; 
		ser[1].subestado = 5; 
